...
transfer). The headline gap is even larger: the judge reaches only
...
significant ($+0.017$, CI $[0.010,0.024]$, $p\!\approx\!0$), and depth still
...
($0.632$/$0.685$). The output bottleneck is attenuation of the signal en route
